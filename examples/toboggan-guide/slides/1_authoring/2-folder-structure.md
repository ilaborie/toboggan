...
> [!NOTE] Only these names are special (exact match): `_cover.md`, `_part.md`, `_head.html`, `_footer.html`, `_preamble.typ`. Everything else is a slide, sorted alphabetically — so prefix files with `1-`, `2-`, … to control order.
