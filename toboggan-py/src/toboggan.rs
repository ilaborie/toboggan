...
use toboggan_core::{ClientConfig, Command, SlideId, SlidesResponse, State as TState, TalkResponse};
...
impl Toboggan {
    ...
    pub fn goto(&self, slide: usize) {
        self.send(Command::GoTo {
            slide: SlideId::new(slide.saturating_sub(1)),
        });
    }
