...
/// hatch worth having: the theme, the aspect ratio and the base text size are
/// chosen here, and nothing written afterwards can take them back.
///
    ...
    fn test_deck_preamble_replaces_the_generated_one() {
        ...
        talk.typst_preamble = Some(
            "#import \"@preview/touying:0.7.3\": *\n#import themes.metropolis: *\n\
             #show: metropolis-theme.with(aspect-ratio: \"4-3\")"
                .to_owned(),
        );
        talk.slides
